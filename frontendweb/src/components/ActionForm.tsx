...
const GetAllUsers = (setAllUsers: React.Dispatch<any>) => {
    ...
    axios.get("http://34.101.42.152:8080/users/all")
        .then((res) => {
...
const ActionForm: FunctionComponent<Props> = ({ action }) => {
    ...
    function handleAddUser(e: React.SyntheticEvent) {
        ...
        // Handle Post Request
        axios.post("http://34.101.42.152/users/add", {
    ...
    function handleDeleteUser(e: React.SyntheticEvent) {
        ...
        axios.delete("http://34.101.42.152/users/delete", { data: { "username": formInput.username } })
    ...
    function handleUpdateUser(e: React.SyntheticEvent) {
        e.preventDefault()
        axios.patch(`http://34.101.42.152/users/update/user/`, {
            "original": modifyUser,
            "username": formInput.username,
            "password": formInput.password,
            "mobile": formInput.mobile
    ...
    function handleUpdateMobile(e: React.SyntheticEvent) {
        e.preventDefault()
        axios.patch(`http://34.101.42.152/users/update/mobile/${cookies.username}`, {
            "mobile": formInput.mobile
        })
            .then(_ => window.location.reload())
            .then(_ => clearFormInputs(setFormInput))
